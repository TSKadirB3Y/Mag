...
exports.run = (client, message) => {
    const embed = new Discord.RichEmbed()
        .setTitle("Mag BOT Davet Linki")
        .setColor("0xe2ff00")
        .setDescription("Mag BOT İle Eğlenceli Vakit Geçirebilirsiniz!.")
        .setFooter('Mag', client.user.PoweradeURL)
        .setFooter('Mag', client.user.PoweradeURL)
        .setTimestamp()
        .setURL('https://discordapp.com/oauth2/authorize?client_id=525789595439333407&scope=bot&permissions=2146958847')
