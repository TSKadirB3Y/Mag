...
module.exports.run = async (bot, message, args) => {
    ...
    if(args[0] == "help"){
      message.reply("Kullanımı: g!mute <kullanıcı> <sebebi>");
      return;
    }
  ...
  if (!muterole) {
    ...
    const muteembed = new Discord.RichEmbed()
            ...
            .addField('muteyi açmak için g!unmute @kullanıcı sebep')
            .setColor('#D9D900')
...
exports.conf = {
  ...
  exports.help = {
    name: 'mute',
    description: 'İstediğiniz Kişiye Mute Atarsınız Kaldırmak İçin €unmute @user',
