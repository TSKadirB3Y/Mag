...
if (mention != null || mention != undefined) {
  ...
  .addField('Mag BOT| Avatar Sistemi', `[Avatarın büyük halini göster!](${mention.avatarURL})`, false);
  message.react("����");
  ...
  .addField('Mag Bot| Avatar Sistemi', `[Avatarın büyük halini göster!](${message.author.avatarURL})`, false);
  console.log("Mag avatar komutu " + message.author.username + '#' + message.author.discriminator + " tarafından kullanıldı.")
